...
@section('sub-title','Branch Editing')
@section('content')
<div class="card card-container action-form-card">
    <div class="card-body">
        <h2 class="ps-1 card-header-title">
            <strong>Update Branches</strong>
        </h2>
        <form action="{{route('branches.update', $branch->id)}}" method="POST" class="action-form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row m-0 mb-3">
                ...
                <div class="col-10">
                    <input type="text" id="name" name="name" value="{{$branch->name}}" class="form-control" />
                    @if ($errors->has('name'))
            ...
            <div class="row m-0 mb-3">
                ...
                <div class="col-10">
                    <input type="text" id="phone_number" name="phone_number" value="{{$branch->phone_number}}" class="form-control" />
            ...
            <div class="row m-0 mb-3">
                ...
                <div class="col-10">
                    <input type="text" id="address" name="address" value="{{$branch->address}}" class="form-control" />
