...
<div class="card card-container action-form-card">
    <div class="card-body">
        ...
        <form action="{{url('/third-party-vendor/'.$thirdPartyVendor->id.'/assign-township')}}" method="POST" class="action-form" enctype="multipart/form-data">
            @csrf
            <div class="row m-0 mb-3">
                ...
                <div class="col-10">
                    <input type="text" id="name" name="name" value="{{$thirdPartyVendor->name}}" class="form-control" readonly/>
                    @if($errors->has('name'))
            ...
            <div class="row m-0 mb-3 selectsearch">
                ...
                <div class="col-10">
                    <select name="township_id[]" id="township_id" class="form-control" multiple="">
                        <option value="" disabled>Select Townships for This Third Party Vendor</option>
            ...
            <div class="footer-button float-end">
                <a href="{{route('third-party-vendor.show', $thirdPartyVendor->id)}}" class="btn btn-light">Cancel</a>
