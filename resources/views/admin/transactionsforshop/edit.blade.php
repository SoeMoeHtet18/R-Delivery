...
@section('content')
        <div class="card card-container">
            <div class="card-body">
                ...
                <form action="{{route('transactions-for-shop.update', $transaction_for_shop->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row m-0 mb-3">
                        ...
                        <div class="col-10">
                            <input type="text" id="paid_by" name="paid_by" value="{{$transaction_for_shop->paid_by}}" class="form-control"/>
