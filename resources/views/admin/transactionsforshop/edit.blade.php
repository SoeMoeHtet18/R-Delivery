    ...
    <div class="card-body">
        ...
        <form action="{{route('transactions-for-shop.update', $transaction_for_shop->id)}}" method="POST" class="action-form" enctype="multipart/form-data">
            ...
            <div class="row m-0 mb-3">
                ...
                <div class="col-10">
                    <select name="type" id="type" class="form-control">
                        ...
                        <option value="fully_payment" @if($transaction_for_shop->type == "fully_payment") {{'selected'}} @endif>Fully Payment</option>
                        <option value="loan_payment" @if($transaction_for_shop->type == "loan_payment") {{'selected'}} @endif>Loan Payment</option>
                    </select>
                </div>
            </div>
            <div class="row m-0 mb-3">
            ...
            <div class="row m-0 mb-3">
                ...
                <div class="col-10">
                    <textarea name="description" id="description" class="form-control" style="height: 100px" placeholder="Write description here">{{$transaction_for_shop->description}}</textarea>
                </div>
            </div>
