...
<script>
    $(document).ready(function() {
        var $citySelectBox = $('#city_id');
        $citySelectBox.select2({width: '100%'});
        var $townshipSelectBox = $('#township_id');
        $townshipSelectBox.select2({width: '100%'});
        var $riderSelectBox = $('#rider_id');
